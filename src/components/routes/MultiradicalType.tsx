fc3", "\u6238", "\u624b", "\u652f", "\u6535", "\u65a4", "\u65b9", "\u65e5", "\u66f0", "\u6708", "\u6728", "\u6b20", "\u6b62", "\u6b79", "\u6bb3", "\u6bd4", "\u6c0f", "\u6c34", "\u706b", "\u722a", "\u725b", "\u72ac", "\u738b"], "3": ["\u2ecc", "\u2ecf", "\u30e8", "\u53e3", "\u571f", "\u58eb", "\u5902", "\u5915", "\u5927", "\u5973", "\u5b50", "\u5bf8", "\u5c0f", "\u5c6e", "\u5c71", "\u5ddb", "\u5de5", "\u5df2", "\u5dfe", "\u5e72", "\u5e7a", "\u5efe", "\u5f13", "\u5f61"], "5": ["\u2f71", "\u518a", "\u7518", "\u7528", "\u7530", "\u758b", "\u767d", "\u76bf", "\u76ee", "\u77db", "\u77e2", "\u77f3", "\u793a", "\u79be", "\u7a74", "\u7acb"], "1": ["\u30ce", "\u4e00", "\u4e36", "\u4e59", "\u4e85", "\uff5c"], "6": ["\u7c73", "\u7cf8", "\u7f36", "\u7f8a", "\u7fbd", "\u800c", "\u8033", "\u807f", "\u81ea", "\u81f3", "\u81fc", "\u821f", "\u826e", "\u8863", "\u897f"], "7": ["\u81e3", "\u898b", "\u8c46", "\u8c55", "\u8c9d", "\u8f9b", "\u9149", "\u91cc"], "8": ["\u9577", "\u96b9", "\u975e"], "9": ["\u9769", "\u97f3", "\u9801"], "10": ["\u99ac", "\u9adf"], "11": ["\u9ce5", "\u9e7f"]}}
      ...
      <ContentContainer>
        <RadicalHeaders>
          <StructuredRow columns={3} rows={5}>
            {SORTED_RADICALS["l"].map((s:string, i) => {
              console.log(s)
              return <RadicalStateButton handleClick={handleSelection} key={i} radical={s} state={radicalsState[s]} />
            })};
          </StructuredRow>
          <StructuredRow columns={3} rows={5}>
            {SORTED_RADICALS["e"].map((s:string, i) => {
              console.log(s)
              return <RadicalStateButton handleClick={handleSelection} key={i} radical={s} state={radicalsState[s]} />
            })};
          </StructuredRow>
          <StructuredRow columns={3} rows={5}>
            {SORTED_RADICALS["t"].map((s:string, i) => {
              console.log(s)
              return <RadicalStateButton handleClick={handleSelection} key={i} radical={s} state={radicalsState[s]} />
            })};
          </StructuredRow>
        ...
        <RowContainer>
          {Object.keys(SORTED_RADICALS["r"]).map((s:string, i) => {
        ...
        <RowContainer>
          {Object.keys(SORTED_RADICALS["unc"]).map((s:string, i) => {
