...
const Header: React.FC<WithTranslation> = ({ t }) => {
  ...
  return (
    <Container>
      ...
      <HeaderButton onClick={handleAboutNavClick}>
        {/* <Icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <path d="M220 220h32v116" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"  />
          <path d="M208 340h88" fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="32"  />
          <path d="M248 130a26 26 0 1026 26 26 26 0 00-26-26z"/>
        </Icon> */}
        <ButtonText>{t("header.about")}</ButtonText>
      </HeaderButton>
